...
import { useTranslation } from "@/app/i18n/LanguageContext"; // <-- ADD THIS
import ClientNav from "@/app/components/ClientNav";

const mooli = Mooli({ weight: "400", subsets: ["latin"] });

export default function CartPage({ params }) {
  const { t, lang } = useTranslation(); // <-- translation hook
  ...
  return (
    <div>
      ...
      <div
        className={`relative px-6 text-white min-h-screen py-28 ${mooli.className}`}
        style={{
